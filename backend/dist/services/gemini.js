...
exports.generateAIAliases = generateAIAliases;
async function generateAIAliases(targetUrl, campaignTitle) {
 ...
 */
function generateStaticFallback(targetUrl, campaignTitle) {
    const suggestions = [];
